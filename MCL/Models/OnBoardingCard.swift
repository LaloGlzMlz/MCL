...
struct OnBoardingCard: View {
    var onBoardingItem: OnBoardinItem
    ...
    var body: some View {
            ...
            VStack(spacing: 20) {
               ...
               Spacer()
                onBoardingItem.image
                    .resizable()
                    .scaledToFit()
                    .frame(height: imageSideMeasure / 2)
                    .shadow(color: Color(red: 0, green: 0, blue: 0, opacity: 0.15), radius: 8, x: 6, y: 8)
                    .foregroundStyle(Color(hex: "E4255B"))
                Spacer()
        ...
        .frame(minWidth: 0, maxWidth: UIScreen.main.bounds.width, minHeight: 0, maxHeight: .infinity, alignment: .trailing)
        .cornerRadius(20)
